...
const sample = require('../tests/fixtures/sample-nascimento-crc.json');
const out = buildNascimentoXmlFromJson(template, sample);
fs.mkdirSync(path.resolve(__dirname, '../artifacts/out'), { recursive: true });
const outPath = path.resolve(__dirname, '../artifacts/out/nascimento-crc-gerado.xml');
