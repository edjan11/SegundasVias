...
export function setupCasamentoDates(opts: any = {}) {
	const dataTermo = document.querySelector(opts.dataTermoSelector || 'input[name="dataTermo"]') as HTMLInputElement | null;
	const tipo = document.querySelector(opts.tipoSelector || 'select[name="tipoCasamento"]') as HTMLSelectElement | null;
	const dataCasamento = document.querySelector(
		opts.dataCasamentoSelector || 'input[name="dataCasamento"]',
	) as HTMLInputElement | null;
	const regime = document.querySelector(opts.regimeSelector || 'select[name="regimeBens"]') as HTMLSelectElement | null;
